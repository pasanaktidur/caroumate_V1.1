...
export const translations = {
  en: {
    ...
    loginSubtitle: 'Enter your details to access your workspace.',
    registerSubtitle: 'Start creating stunning carousels today.',
  ...
  id: {
    ...
    loginSubtitle: 'Masuk untuk mengakses ruang kerja Anda.',
    registerSubtitle: 'Mulai buat carousel memukau sekarang.',
    ...
    checkEmailConfirmation: 'Silakan cek email Anda untuk konfirmasi akun.',
    heroTagline: 'CarouMate AI',
